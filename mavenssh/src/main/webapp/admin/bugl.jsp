...
<div id="admin_bugl_layout" class="easyui-layout" data-options="fit:true">
    <div data-options="region:'north',title:'高级查询 ',split:true" style="height:100px;">
    <form id="admin_bugl_searchform">
          用户名： <input name="name"/>
    ...
    <table id="admin_bugl_dg" class="easyui-datagrid" data-options="rownumbers:true,singleSelect:false,
